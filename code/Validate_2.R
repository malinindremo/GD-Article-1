...
Validate_2 <- function(d){
  ...
  xlsx::write.xlsx2(pd, file=
                      file.path(FOLDERS$results_today,"validation","Validate_2_treatment_all_ages.xlsx"))
  ...
  q
  SaveA4(q,file.path(FOLDERS$results_today,"validation","Validate_2_treatment_all_ages_numbers.png"))
  ...
  q <- q + scale_fill_brewer("",palette="Set1")
  q
  SaveA4(q,file.path(FOLDERS$results_today,"validation","Validate_2_treatment_all_ages_percentages.png"))
  ...
  xlsx::write.xlsx2(pd, file=
                      file.path(FOLDERS$results_today,"validation","Validate_2_treatment_under_18.xlsx"))
  ...
  q <- q + scale_fill_brewer("",palette="Set1")
  q
  SaveA4(q,file.path(FOLDERS$results_today,"validation","Validate_2_treatment_under_18_numbers.png"))
  ...
  q <- q + scale_fill_brewer("",palette="Set1")
  q
  SaveA4(q,file.path(FOLDERS$results_today,"validation","Validate_2_treatment_under_18_percentages.png"))
  ...
  xlsx::write.xlsx2(pd, file=
                      file.path(FOLDERS$results_today,"validation","Validate_2_numdiag_all_ages.xlsx"))
  ...
  q
  SaveA4(q,file.path(FOLDERS$results_today,"validation","Validate_2_numdiag_all_ages.png"))
  ...
  xlsx::write.xlsx2(pd, file=
                      file.path(FOLDERS$results_today,"validation","Validate_2_numdiag_under_18.xlsx"))
  ...
  q <- q + scale_y_continuous("Average number numF64_089 diagnoses")
  q
  SaveA4(q,file.path(FOLDERS$results_today,"validation","Validate_2_numdiag_under_18.png"))
